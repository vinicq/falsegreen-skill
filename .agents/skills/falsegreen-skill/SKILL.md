...
This is the Antigravity CLI (`agy`) Agent Skill entry point. `agy` discovers
skills under `.agents/skills/`. The canonical protocol stays at the repository
root to avoid drift across hosts.
